...
public class ActivationViewSolved : MonoBehaviour
{
    ...
    void Awake()
    {
        if (FindObjectsOfType<ActivationViewSolved>().Length <= 1) viewCounter = 0;
    ...
    public void InitActivationBox(string type)
    {
        ...
        activationBox.transform.parent = activationBoxHolder.transform;
        activationBox.transform.position = new Vector3(activationBoxHolder.transform.position.x + horizontalOffset, activationBoxHolder.transform.position.y + verticalOffset);
