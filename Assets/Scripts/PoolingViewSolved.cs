...
public class PoolingViewSolved : MonoBehaviour
{
    ...
    void Awake()
    {
        if (FindObjectsOfType<PoolingViewSolved>().Length <= 1) viewCounter = 0;
    ...
    public void InitPoolingBox(string type)
    {
        ...
        poolingBox.transform.parent = poolingBoxHolder.transform;
        poolingBox.transform.position = new Vector3(poolingBoxHolder.transform.position.x + horizontalOffset, poolingBoxHolder.transform.position.y + verticalOffset);
